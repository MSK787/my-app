      ...
      <section>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {ITEMS.map((id) => (
            <figure
              key={id}
              className="flex flex-col gap-3 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-slate-200/70"
            >
