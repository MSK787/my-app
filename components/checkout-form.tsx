  ...
  if (placed) {
    return (
      <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-8 text-center">
        ...
        <Link
          href="/products"
          className="mt-4 inline-block rounded-full bg-slate-900 px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-amber-700"
        >
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none focus:border-amber-500"
          />
        </label>
        <label className="block">
          <span className="text-sm font-medium text-slate-700">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <label className="block">
          ...
          <select
            name="country"
            className="mt-1 w-full rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-sm outline-none focus:border-amber-500"
          >
      ...
      <button
        type="submit"
        className="w-full rounded-full bg-slate-900 py-3 text-sm font-semibold text-white transition hover:bg-amber-700"
      >
